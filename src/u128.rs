...
mod interval_arithmetic {
    ...
    impl U128CO {
        #[inline]
        pub const fn scale(self, factor: u128) -> Option<Self> {
            if factor == 0 || self.end_excl > u128::MAX / factor {
                return None;
            }
            Some(U128CO::new_unchecked(
                self.start * factor,
        ...
        #[inline]
        pub const fn shift(self, offset: u128) -> Option<Self> {
            if self.end_excl > u128::MAX - offset {
                return None;
            }
            Some(U128CO::new_unchecked(
                self.start + offset,
