...
mod interval_arithmetic {
    ...
    impl I64CO {
        #[inline]
        pub const fn scale(self, factor: i64) -> Option<Self> {
            if factor == 0 {
                return None;
            }
            ...
            if s0 < s1 {
                Some(I64CO::new_unchecked(s0, s1))
            } else {
                Some(I64CO::new_unchecked(s1, s0))
            }
        }

        #[inline]
        pub const fn shift(self, offset: i64) -> Option<Self> {
