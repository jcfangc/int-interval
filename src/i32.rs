...
mod interval_arithmetic {
    ...
    impl I32CO {
        #[inline]
        pub const fn scale(self, factor: i32) -> Option<Self> {
            if factor == 0 {
                return None;
            }
            ...
            if s0 < s1 {
                Some(I32CO::new_unchecked(s0, s1))
            } else {
                Some(I32CO::new_unchecked(s1, s0))
            }
        }

        #[inline]
        pub const fn shift(self, offset: i32) -> Option<Self> {
