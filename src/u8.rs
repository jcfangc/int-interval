...
pub mod minkowski {
    ...
    impl U8CO {
        ...
        #[inline]
        pub const fn minkowski_add_n(self, n: u8) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_sub_n(self, n: u8) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_mul_n(self, n: u8) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_div_n(self, n: u8) -> Option<Self> {
            if n == 0 {
                return None; // avoid division by zero
            }
