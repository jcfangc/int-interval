...
mod construction_accessors_predicates {
    ...
    impl I128CO {
        ...
        #[inline]
        pub(super) const fn new_unchecked(start: i128, end_excl: i128) -> Self {
        ...
        pub const fn len(self) -> u128 {
            (self.end_excl - self.start) as u128
        }
...
pub mod minkowski {
    ...
    pub mod checked {
        ...
        impl I128CO {
            #[inline]
            pub const fn checked_minkowski_add_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_sub_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_mul_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_div_n(self, n: i128) -> Option<Self> {
                if n == 0 {
                    return None;
                }
    ...
    pub mod saturating {
        ...
        impl I128CO {
            #[inline]
            pub const fn saturating_minkowski_add_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_sub_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_mul_n(self, n: i128) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_div_n(self, n: i128) -> Option<Self> {
                if n == 0 {
                    return None;
                }
