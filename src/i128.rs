...
mod interval_arithmetic {
    ...
    impl I128CO {
        #[inline]
        pub const fn scale(self, factor: i128) -> Option<Self> {
            if factor == 0 {
                return None;
            }
            ...
            if s0 < s1 {
                Some(I128CO::new_unchecked(s0, s1))
            } else {
                Some(I128CO::new_unchecked(s1, s0))
            }
        }

        #[inline]
        pub const fn shift(self, offset: i128) -> Option<Self> {
