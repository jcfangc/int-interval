...
mod construction_accessors_predicates {
    ...
    impl I16CO {
        ...
        #[inline]
        pub(super) const fn new_unchecked(start: i16, end_excl: i16) -> Self {
        ...
        pub const fn len(self) -> u16 {
            (self.end_excl - self.start) as u16
        }
...
mod interval_arithmetic {
    ...
    impl I16CO {
        #[inline]
        pub const fn scale(self, factor: i16) -> Option<Self> {
            if factor == 0 {
                return None;
            }
            ...
            if s0 < s1 {
                Some(I16CO::new_unchecked(s0, s1))
            } else {
                Some(I16CO::new_unchecked(s1, s0))
            }
        }

        #[inline]
        pub const fn shift(self, offset: i16) -> Option<Self> {
