...
mod interval_arithmetic {
    ...
    impl U32CO {
        #[inline]
        pub const fn scale(self, factor: u32) -> Option<Self> {
            if factor == 0 || self.end_excl > u32::MAX / factor {
                return None;
            }
            Some(U32CO::new_unchecked(
                self.start * factor,
        ...
        #[inline]
        pub const fn shift(self, offset: u32) -> Option<Self> {
            if self.end_excl > u32::MAX - offset {
                return None;
            }
            Some(U32CO::new_unchecked(
                self.start + offset,
