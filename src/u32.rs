...
mod construction_accessors_predicates {
    ...
    impl U32CO {
        ...
        #[inline]
        pub(super) const fn new_unchecked(start: u32, end_excl: u32) -> Self {
...
pub mod minkowski {
    ...
    impl U32CO {
        ...
        #[inline]
        pub const fn minkowski_add_n(self, n: u32) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_sub_n(self, n: u32) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_mul_n(self, n: u32) -> Option<Self> {
        ...
        #[inline]
        pub const fn minkowski_div_n(self, n: u32) -> Option<Self> {
            if n == 0 {
                return None; // avoid division by zero
            }
